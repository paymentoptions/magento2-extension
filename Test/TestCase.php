...
namespace Agtech\Paymentoptions\Test;
...
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
     ...
     * @return MockObject
     */
    protected function getPaymentoptionsClientMock(): MockObject
    {
        $PaymentoptionsClient = $this->getMockBuilder(\PaymentoptionsPro\Client::class)->disableOriginalConstructor()->setMethods(['redirectFlows', 'payments'])->getMock();
