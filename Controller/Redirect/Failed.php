...
class Failed extends AbstractRedirectAction
{
    /** @var  OrderPlace */
    private $orderPlace;
    ...
    public function execute()
    {
        try {
            ...
            $order->addCommentToStatusHistory("Customer Redirect back from PaymentOptions Gateway After Transaction because of failed or cancled.");
            $order->cancel()->save();   
            ...
            $this->messageManager->addError("Order is Cancled or Failed.");
